...
export function Topbar({
  ...
  return (
    <header className="flex min-h-[150px] flex-wrap items-end justify-between gap-4 bg-primary px-4 py-6 text-inverse-fg sm:min-h-[170px] sm:px-6 sm:py-8 md:min-h-[200px] md:px-14 md:py-12">
      <div>
        <h1 className="break-words text-[clamp(28px,7vw,64px)] leading-[0.95] tracking-[-1px] text-inverse-fg sm:tracking-[-2px]">
          {title}
        </h1>
        {subtitle ? (
          <p className="mt-2 font-mono text-[10px] uppercase tracking-[0.06em] text-muted-2 sm:text-caption sm:tracking-[0.08em]">
            {subtitle}
          </p>
        ) : null}
      </div>
